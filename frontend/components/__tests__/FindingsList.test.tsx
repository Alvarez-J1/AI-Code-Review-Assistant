  ...
  it("filters findings by severity without refetching", async () => {
    ...
    expect(
      screen.getByRole("link", {
        name: "Open GitHub pull request for finding: Missing webhook signature verification in a new tab"
      })
    ).toHaveAttribute("href", "https://github.com/acme/payments/pull/42");
  });
